...
class GISTV10(hmc.HMCBase):
    ...
    * the segment_length to increase as the trajectory
    grows, and

    * limit the forward trajectory to switch_limit switches,
    instead of min_{leapfrog steps} (switch_limit interset end_segment).

    Seems to give same results as before with fewer leapfrog steps
    ...
    def __init__(self, model, stepsize, theta = None, seed = None,
        ...
        self.sampler_name = f"GIST-V10_{switch_limit}"
