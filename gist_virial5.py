...
class GISTV5(hmc.HMCBase):
    ...
    biased towards the end of the trajectory in segments consisting of 4 steps.  Biasing analogous to
    Stan.
    ...
    def __init__(self, model, stepsize,
        ...
        self.sampler_name = "GIST-Virial-5"
        if theta is None:
    ...
    def trajectory(self, theta, rho, lsw = 0.0, switch_discount = 0):
        ...
        while True:
          ...
          # sample potential-proposal from within every 4 steps
          # if steps % 4 == 0:
              #
